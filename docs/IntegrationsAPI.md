...
# **integrationsExecute**
```swift
    open class func integrationsExecute(projectId: String, integrationId: String, integrationsExecuteRequest: IntegrationsExecuteRequest, completion: @escaping (_ data: WalletTestWebhook200Response?, _ error: Error?) -> Void)
```
