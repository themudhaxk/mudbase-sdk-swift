...
let authResendVerificationRequest = auth_resendVerification_request(email: "email_example", projectId: "projectId_example") // AuthResendVerificationRequest | 
...
let authVerifyEmailRequest = auth_verifyEmail_request(token: "token_example", projectId: "projectId_example") // AuthVerifyEmailRequest | 
